...
if is_shorts_mode:
    ...
    <style>
        ...
        /* 📱 쇼츠 화면 고정 (하단 자막 공간 확보) */
        .block-container { 
            padding: 1.5rem 1.0rem 4.5rem 1.0rem !important; 
        ...
        /* 1️⃣ 제목 크기 축소 및 한 줄 고정 */
        .s-title { 
            text-align: center; color: #facc15; 
            font-size: 1.8rem; font-weight: 900; 
            margin-bottom: 5px; text-shadow: 2px 2px 4px rgba(0,0,0,0.5);
            white-space: nowrap; 
        }
        
        /* 2️⃣ 카드 전체 디자인 (10개가 다 들어가도록 상하 여백 압축) */
        .s-card { 
            background-color: #1e293b; border-radius: 12px; padding: 12px 15px; 
        ...
        .s-rank { 
            ...
            min-width: 22px; height: 22px; display: flex; justify-content: center; align-items: center; 
        ...
        .s-eval { 
            font-size: 0.85rem; color: #facc15; font-weight: bold; 
            background: #0f172a; padding: 3px 6px; border-radius: 5px; 
        ...
        .s-score { 
            font-size: 0.95rem; color: #10b981; font-weight: bold; 
            background: rgba(16, 185, 129, 0.15); padding: 3px 8px; border-radius: 5px; 
        }
        
        /* 3️⃣ 하단 유튜브 정책 (움직이는 뉴스 속보 자막 효과) */
        .s-marquee {
            position: fixed; bottom: 0; left: 0; width: 100%;
            background-color: #b91c1c; color: white;
            padding: 12px 0; font-size: 1.2rem; font-weight: bold;
    ...
    if not df_shorts.empty:
        ...
        for i, (index, row) in enumerate(top_10.iterrows(), 1):
            ...
            ratio_class = "up" if rate > 0 else "down"
            sign = "+" if rate > 0 else ""
                ...
                <div class="s-card">
                    ...
                    <div class="s-card-bottom">
                        <div class="s-price-box">
                            ...
                            <span class="s-ratio {ratio_class}">{sign}{rate:.2f}%</span>
                        </div>
